(function ($) {
    ...
    if ($.fn.owlCarousel) {
        ...
        $(".calibri-hero-slides").owlCarousel({
            items: 1,
            loop: true,
            autoplay: true,
            smartSpeed: 1500,
        ...
        var wel_slides = $('.calibri-hero-slides');
        ...
        wel_slides.on('translate.owl.carousel', function (event) {
            ...
            $('.hero-slides-nav, .calibri-hero-area .owl-next').removeClass('animated').hide();
        })
        wel_slides.on('translated.owl.carousel', function (event) {
            ...
            $('.hero-slides-nav, .calibri-hero-area .owl-next').addClass('animated fadeInUp').show();
        })
        // Testimonials Slider Active Code
        $(".calibri-testimonials-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 1500,
        ...
        $(".calibri-menu-slides").owlCarousel({
            items: 1,
            loop: true,
            autoplay: true,
            smartSpeed: 1500,
    ...
    if ($.fn.imagesLoaded) {
        $('.calibri-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.calibri-portfolio').isotope({
